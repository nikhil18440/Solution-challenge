...
if(k<=5){         img.setAttribute('src', `Solution-challenge.github.io/Untitled-${k}.png`)  ;       k++     }else{         k=1 ;        img.setAttribute('src', `Solution-challenge.github.io/Untitled-${k}.png`)     } ;     img.style.position = 'absolute'  ;   img.style.zIndex = -1;     img.style.left = `${j}px` ;    j = j+80     ;     if(i%2!==0){         img.style.top = 0        ; img.setAttribute('class',`sec1ImgOdd`);
